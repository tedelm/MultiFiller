...
Parts list:
- MFIller_CAN_CounterPressure_w_gasline_noVitamins-TPU.stl
- MFiller_guide_cylinder_mount-PLA.stl
- MFiller_guide_cylinder-PLA_v1.1.stl
- MFiller_guide_cylinder-stopper-PLA_v1.1.stl 
- 1/4" pipe (stainless steel)
- Rubberband 
